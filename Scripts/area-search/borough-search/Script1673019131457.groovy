...
WebUI.setText(findTestObject('Page_Address Intelligence/input_Group 1__AI_ai-omnibox_24_freetext'), 'barnet')

WebUI.click(findTestObject('Object Repository/Page_Address Intelligence/li_Barnet              city'))
